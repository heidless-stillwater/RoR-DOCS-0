...
```
source ./config/.env-vars
create_instance_dir='../../RoR-DOCS-0/Admin/RoR-CREATE-INSTANCE'
...
gcp:
  ...
  db_database: airbnb-app-1-db-0
  db_username: airbnb-app-1-user-0
  db_instance_host: heidless-ror-8:europe-west1:airbnb-app-1-instance-0
maps:
...
gcp:
  ...
  db_database: alpha-blog-db-0
  db_username: alpha-blog-user-0
  db_instance_host: heidless-ror-8:europe-west1:alpha-blog-instance-0
aws_credentials:
